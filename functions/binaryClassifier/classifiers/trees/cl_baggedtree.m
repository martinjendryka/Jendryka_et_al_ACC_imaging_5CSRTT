function [trainedClassifier] = cl_baggedtree(trainingData, responseData)
...
% Auto-generated by MATLAB on 29-Jun-2020 16:08:59
...
%         x = classificationEnsemble.Trained{j}.PredictorNames{1,i};
%         if length(x) == 9
%             x = str2num(x(end));
%         elseif length(x) == 10
