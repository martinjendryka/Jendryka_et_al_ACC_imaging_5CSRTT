function [trainedClassifier] = cl_linearSVM_opti(trainingData, responseData)
...
% model.
% isnanidx = all(isnan(trainingData),1); % remove feature columns which are all nan
% trainingData(:,isnanidx) = [];
% x_test(:,isnanidx) = [];
