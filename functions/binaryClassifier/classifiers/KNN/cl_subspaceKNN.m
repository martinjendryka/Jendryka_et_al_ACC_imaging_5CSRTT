function [trainedClassifier, y_predict] = cl_subspaceKNN(trainingData, responseData,x_test)
...
% Auto-generated by MATLAB on 10-Nov-2021 11:58:40
...
subspaceDimension = max(1, min(12, width(trainingData) - 1));
